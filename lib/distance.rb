class Distance
  ...
  def self.points
    {
      same:         2 * ABSENT_FACTOR,  #10
      differ:       0,
      absent:       1,
      samestrong:   2 * STRONG_FACTOR * ABSENT_FACTOR, #50
      differstrong: 0,
      absentstrong: 1 * STRONG_FACTOR * ABSENT_FACTOR #25
    }
  end
  ...
  def self.possible_points
    {
      same:         2 * ABSENT_FACTOR, #10
      differ:       2 * ABSENT_FACTOR, #10
      absent:       2,
      samestrong:   2 * STRONG_FACTOR * ABSENT_FACTOR, #50
      differstrong: 2 * STRONG_FACTOR * ABSENT_FACTOR, #50
      absentstrong: 2 * STRONG_FACTOR * ABSENT_FACTOR  #50
    }
  end
