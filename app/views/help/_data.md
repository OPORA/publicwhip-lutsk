...
|friend_deputy_id | унікальний ідентифікатор депутата, для якого обраховується відсоток спільних голосувань |
|count | обрахований відсоток спільних голосувань |
|date_mp_friend | місяць, за який обраховано відсоток спільних голосувань|
...
Перейшовши за цим запитом можна отримати інформацію про те, як голосував кожен депутат в конкретному голосуванні з унікальним ідентифікатором `division_id=1918`. 
*Примітка: щоб подивитись деталі іншого голосування, замість `“1918”` потрібно підставити `division_id` обраного голосування.
...
Перейшовши за цим посиланням можна отримати результати голосування з унікальним ідентифікатором `division_id=1918` в розрізі депутатських фракцій. 
*Примітка: щоб подивитись деталі іншого голосування, замість `“1918”` використовуйте `division_id` обраного голосування.
