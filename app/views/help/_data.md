...
|friend\_deputy\_id | унікальний ідентифікатор депутата, для якого обраховується відсоток спільних голосувань |
...
| policy\_person\_distances | підструктура, яка містить реєстр з реультатами голосувань кожного депутата  | 
